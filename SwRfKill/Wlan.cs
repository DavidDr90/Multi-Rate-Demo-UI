...
namespace Net
{
    ...
    public static class Wlan
    {
        ...
        public static extern int WlanGetInterfaceCapability(
            ...
            [Out] out IntPtr interfaceCapabilityPtr);
        ...
        public struct WlanAvailableNetwork
        {
            ...
            /// When this member is set to <c>true</c>, an application must call <see cref="WlanInterface.GetNetworkBssList"/> to get the complete list of PHY types.
            ...
            public override string ToString()
            {
                ...
                sb.AppendFormat("SSID: {0}, ", dot11Ssid.GetSsid());
                sb.AppendFormat("profileName: {0}, ", profileName);
                sb.AppendFormat("numberOfBssids: {0}, ", numberOfBssids);
                sb.AppendFormat("securityEnabled: {0}, ", securityEnabled);
                sb.AppendFormat("dot11DefaultAuthAlgorithm: {0}, ", dot11DefaultAuthAlgorithm);
                sb.AppendFormat("dot11DefaultCipherAlgorithm: {0}, ", dot11DefaultCipherAlgorithm);
        ...
        public static extern int WlanReasonCodeToString(
            ...
            [In] int bufferSize,
            [In, MarshalAs(UnmanagedType.LPWStr), Out] StringBuilder stringBuffer,
            IntPtr pReserved
        );
        ...
        /// </summary>
        /// <remarks>Represents <c>WLAN_NOTIFICATION_SOURCE_NONE</c></remarks>
        [Flags]
        ...
        /// <summary>
        /// Defines the types of an OneX (<see cref="WlanNotificationSource.OneX"/>) notifications.
        /// </summary>
        /// <remarks>
        /// The enumeration identifiers correspond to the native <c>OneX</c> identifiers.
        /// </remarks>
        public enum WlanNotificationCodeOneX
        {
        ...
        public struct WlanNotificationData
        {
                ...
                get
                {
                    switch (notificationSource)
                    {
                        ...
                        case WlanNotificationSource.OneX:
                            return (WlanNotificationCodeOneX)notificationCode;
                        default:
            ...
            /// <summary>
            /// Gets a value indicating whether this notification has data.
            /// </summary>
            public bool HasData
            {
                get
        ...
        public struct WlanConnectionParameters
        {
            ...
            public override string ToString()
            {
                return $"Profile name: {profile}, Dot11SsidPtr: {dot11SsidPtr}, " +
                       $"DesiredBssidListPtr: {desiredBssidListPtr}, Dot11BssType: {dot11BssType}, " +
                       $"WlanConnectionFlags: {flags}";
            }
        }

        /// <summary>
        /// Wraps the WLAN_SIGNAL_QUALITY value
        /// </summary>
        public struct WlanSignalQuality
        {
            ...
            public override string ToString()
            {
                return string.Format("Signal quality: {0}, RSSI: {1}", SignalQuality, Rssi);
            }
        }
        ...
        public struct WlanBssEntry
        {
            ...
            public override string ToString()
            {
                ...
                WlanRateSet rateSet = wlanRateSet;

                sb.AppendFormat("SSID: {0}, ", dot11Ssid.GetSsid());
                sb.AppendFormat("Frequency: {0} MHz, ", chCenterFrequency / 1000.0);
                sb.AppendFormat("RateSet: {0}, ", string.Join(" ", rateSet.Rates.Select((r, i) => rateSet.GetRateInMbps(i) + "Mbps")));
                sb.AppendFormat("RSSI: {0}, ", rssi);
                sb.AppendFormat("BSSID: {0}, ", new PhysicalAddress(dot11Bssid));
                sb.AppendFormat("Beacon period: {0}, ", beaconPeriod);
        ...
        {
            private readonly WlanReasonCode m_ReasonCode;
            ...
            public override string Message
            {
                get
                {
                    ...
                    return
                        WlanReasonCodeToString(m_ReasonCode, sb.Capacity, sb, IntPtr.Zero) == 0 ?
                            sb.ToString() :
                            string.Empty;
                }
            }
        ...
        /// <summary>
        /// Defines the wlan power settings.
        /// </summary>
        /// <remarks>Corresponds to the native type WLAN_POWER_SETTING</remarks>
        ...
        /// </summary>
        /// <remarks>
        /// Corresponds to the native <c>WLAN_MSM_NOTIFICATION_DATA</c> type.
        /// </remarks>
        [StructLayout(LayoutKind.Sequential, CharSet = CharSet.Unicode)]
        public struct WlanMsmNotificationData
        {
            ...
            public Dot11BssType dot11BssType;
            /// <summary>
            /// The MAC address of the peer or the access point
            /// </summary>
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 6)]
            public byte[] dot11MacAddr;
            /// <summary>
            /// Indicates whether security is enabled for this connection.
            /// </summary>
            public bool securityEnabled;
            ...
            /// <summary>
            /// Gets the dot11 mac address.
            /// </summary>
            public PhysicalAddress Dot11MacAddress
            {
                get
                {
                    return new PhysicalAddress(dot11MacAddr);
                }
            }
        }
        ...
        public struct Dot11Ssid
        {
            ...
            /// <summary>
            /// Gets the ssid string representation.
            /// </summary>
            /// <returns></returns>
            public string GetSsid()
            {
                return SSID == null ? "" : Encoding.ASCII.GetString(SSID, 0, (int)SSIDLength);
            }
        }
        ...
        /// <summary>
        /// Corresponds to WLAN_INTERFACE_TYPE 
        /// </summary>
        public enum WlanInterfaceType : uint
        {
            /// <summary>
        ...
        public struct WlanPhyRadioState
        {
            ...
            public override string ToString()
            {
                return string.Format("Phy index: {0} , SW radio: {1} , HW radio: {2}", dwPhyIndex, dot11SoftwareRadioState,
        ...
        /// </summary>
        /// <remarks>Corresponds to WLAN_INTERFACE_CAPABILITY</remarks>
        [StructLayout(LayoutKind.Sequential)]
        public struct WlanInterfaceCapability
        {
            public WlanInterfaceType interfaceType;
        ...
        [DllImport("wlanapi.dll")]
        public static extern int WlanIhvControl(
            [In] IntPtr clientHandle,
            [In, MarshalAs(UnmanagedType.LPStruct)] Guid interfaceGuid,
